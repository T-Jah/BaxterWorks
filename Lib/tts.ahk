...
^!j::s.Speak(gst())			; select some text and press F1 to test Speak()
^!k::s.ToggleSpeak(gst())	; select some text and press F2 to test ToggleSpeak()
^!l::s.NextVoice()			; select some text and press F3 to switch to the next voice
